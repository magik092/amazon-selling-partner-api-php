...
class FbaInventoryApi
{
    ...
    {
        list($response) = $this->addInventoryWithHttpInfo($xAmznIdempotencyToken, $addInventoryRequestBody);
        return $response;
    }
    ...
    {
        list($response) = $this->createInventoryItemWithHttpInfo($createInventoryItemRequestBody);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getInventorySummariesRequest($granularityType, $granularityId, $marketplaceIds, $details = false, $startDateTime = null, $sellerSkus = null, $sellerSku = null, $nextToken = null)
    {
