...
namespace Webcom\Amazon\Rest\ProductPricingApiV0\Api;
...
use Webcom\Amazon\Rest\ProductPricingApiV0\ApiException;
...
class ProductPricingApi
{
     ...
     * @return \Webcom\Amazon\Rest\ProductPricingApiV0\Model\GetPricingResponseV0|\Webcom\Amazon\Rest\ProductPricingApiV0\Model\GetPricingResponseV0|\Webcom\Amazon\Rest\ProductPricingApiV0\Model\GetPricingResponseV0|\Webcom\Amazon\Rest\ProductPricingApiV0\Model\GetPricingResponseV0|\Webcom\Amazon\Rest\ProductPricingApiV0\Model\GetPricingResponseV0|\Webcom\Amazon\Rest\ProductPricingApiV0\Model\GetPricingResponseV0|\Webcom\Amazon\Rest\ProductPricingApiV0\Model\GetPricingResponseV0|\Webcom\Amazon\Rest\ProductPricingApiV0\Model\GetPricingResponseV0
     */
     ...
     * @throws \Webcom\Amazon\Rest\ProductPricingApiV0\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Webcom\Amazon\Rest\ProductPricingApiV0\Model\GetPricingResponseV0|\Webcom\Amazon\Rest\ProductPricingApiV0\Model\GetPricingResponseV0|\Webcom\Amazon\Rest\ProductPricingApiV0\Model\GetPricingResponseV0|\Webcom\Amazon\Rest\ProductPricingApiV0\Model\GetPricingResponseV0|\Webcom\Amazon\Rest\ProductPricingApiV0\Model\GetPricingResponseV0|\Webcom\Amazon\Rest\ProductPricingApiV0\Model\GetPricingResponseV0|\Webcom\Amazon\Rest\ProductPricingApiV0\Model\GetPricingResponseV0|\Webcom\Amazon\Rest\ProductPricingApiV0\Model\GetPricingResponseV0, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCompetitivePricingWithHttpInfo($marketplaceId, $itemType, $asins = null, $skus = null, $customerType = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Webcom\Amazon\Rest\ProductPricingApiV0\Model\GetPricingResponseV0' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Webcom\Amazon\Rest\ProductPricingApiV0\Model\GetPricingResponseV0', []),
            ...
            $returnType = '\Webcom\Amazon\Rest\ProductPricingApiV0\Model\GetPricingResponseV0';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Webcom\Amazon\Rest\ProductPricingApiV0\Model\GetPricingResponseV0',
     ...
     */
    public function getCompetitivePricingRequest($marketplaceId, $itemType, $asins = null, $skus = null, $customerType = null)
    {
        ...
        if (is_array($customerType)) {
            $customerType = ObjectSerializer::serializeCollection($customerType, '', true);
        }
     ...
     * @throws \Webcom\Amazon\Rest\ProductPricingApiV0\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Webcom\Amazon\Rest\ProductPricingApiV0\Model\GetOffersResponseV0|\Webcom\Amazon\Rest\ProductPricingApiV0\Model\GetOffersResponseV0|\Webcom\Amazon\Rest\ProductPricingApiV0\Model\GetOffersResponseV0|\Webcom\Amazon\Rest\ProductPricingApiV0\Model\GetOffersResponseV0|\Webcom\Amazon\Rest\ProductPricingApiV0\Model\GetOffersResponseV0|\Webcom\Amazon\Rest\ProductPricingApiV0\Model\GetOffersResponseV0|\Webcom\Amazon\Rest\ProductPricingApiV0\Model\GetOffersResponseV0|\Webcom\Amazon\Rest\ProductPricingApiV0\Model\GetOffersResponseV0
     */
     ...
     * @throws \Webcom\Amazon\Rest\ProductPricingApiV0\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Webcom\Amazon\Rest\ProductPricingApiV0\Model\GetOffersResponseV0|\Webcom\Amazon\Rest\ProductPricingApiV0\Model\GetOffersResponseV0|\Webcom\Amazon\Rest\ProductPricingApiV0\Model\GetOffersResponseV0|\Webcom\Amazon\Rest\ProductPricingApiV0\Model\GetOffersResponseV0|\Webcom\Amazon\Rest\ProductPricingApiV0\Model\GetOffersResponseV0|\Webcom\Amazon\Rest\ProductPricingApiV0\Model\GetOffersResponseV0|\Webcom\Amazon\Rest\ProductPricingApiV0\Model\GetOffersResponseV0|\Webcom\Amazon\Rest\ProductPricingApiV0\Model\GetOffersResponseV0, HTTP status code, HTTP response headers (array of strings)
     */
    public function getItemOffersWithHttpInfo($marketplaceId, $itemCondition, $asin, $customerType = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Webcom\Amazon\Rest\ProductPricingApiV0\Model\GetOffersResponseV0' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Webcom\Amazon\Rest\ProductPricingApiV0\Model\GetOffersResponseV0', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Webcom\Amazon\Rest\ProductPricingApiV0\Model\GetOffersResponseV0';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Webcom\Amazon\Rest\ProductPricingApiV0\Model\GetOffersResponseV0',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getItemOffersRequest($marketplaceId, $itemCondition, $asin, $customerType = null)
    {
        // verify the required parameter 'marketplaceId' is set
        if ($marketplaceId === null || (is_array($marketplaceId) && count($marketplaceId) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getListingOffersRequest($marketplaceId, $itemCondition, $sellerSKU, $customerType = null)
    {
        // verify the required parameter 'marketplaceId' is set
        if ($marketplaceId === null || (is_array($marketplaceId) && count($marketplaceId) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getPricingRequest($marketplaceId, $itemType, $asins = null, $skus = null, $itemCondition = null, $offerType = null)
    {
        // verify the required parameter 'marketplaceId' is set
        if ($marketplaceId === null || (is_array($marketplaceId) && count($marketplaceId) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if (is_array($offerType)) {
            $offerType = ObjectSerializer::serializeCollection($offerType, '', true);
        }
        if ($offerType !== null) {
