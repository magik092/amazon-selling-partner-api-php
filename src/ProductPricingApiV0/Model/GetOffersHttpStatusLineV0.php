...
/**
 * GetOffersHttpStatusLineV0 Class Doc Comment
 *
 * @category Class
 ...
 */
class GetOffersHttpStatusLineV0 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setStatusCode($statusCode)
    {
        ...
        if (!is_null($statusCode) && ($statusCode > 599)) {
            throw new \InvalidArgumentException('invalid value for $statusCode when calling GetOffersHttpStatusLineV0., must be smaller than or equal to 599.');
        }
        if (!is_null($statusCode) && ($statusCode < 100)) {
            throw new \InvalidArgumentException('invalid value for $statusCode when calling GetOffersHttpStatusLineV0., must be bigger than or equal to 100.');
        }
