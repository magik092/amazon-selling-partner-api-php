...
/**
 * CustomPlacementInput20240320 Class Doc Comment
 *
 * @category Class
 ...
 */
class CustomPlacementInput20240320 implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets items
     *
     * @param \Webcom\Amazon\Rest\FulfillmentInboundApi20240320\Model\ItemInput20240320[] $items Items included while creating Inbound Plan.
     *
     * @return self
     */
    ...
    {
        if ((mb_strlen($warehouseId) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $warehouseId when calling CustomPlacementInput20240320., must be smaller than or equal to 1024.');
        }
        if ((mb_strlen($warehouseId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $warehouseId when calling CustomPlacementInput20240320., must be bigger than or equal to 1.');
        }
