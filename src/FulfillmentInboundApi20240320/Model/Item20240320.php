...
class Item20240320 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setExpiration($expiration)
    {
        ...
        if (!is_null($expiration) && (!preg_match("/^([0-9]{4})-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1])$/", $expiration))) {
            throw new \InvalidArgumentException("invalid value for $expiration when calling Item20240320., must conform to the pattern /^([0-9]{4})-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1])$/.");
        }
    ...
    public function setMsku($msku)
    {
        if ((mb_strlen($msku) > 255)) {
            throw new \InvalidArgumentException('invalid length for $msku when calling Item20240320., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($msku) < 1)) {
    ...
    public function setQuantity($quantity)
    {
        ...
        if (($quantity > 500000)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling Item20240320., must be smaller than or equal to 500000.');
        }
        if (($quantity < 1)) {
