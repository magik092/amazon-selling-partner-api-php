...
/**
 * BoxUpdateInput20240320 Class Doc Comment
 *
 * @category Class
 ...
 */
class BoxUpdateInput20240320 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['packageId']) && (mb_strlen($this->container['packageId']) > 38)) {
        ...
        if (!is_null($this->container['packageId']) && !preg_match("/^[a-zA-Z0-9-]*$/", $this->container['packageId'])) {
     ...
     * Sets packageId
     *
     * @param string|null $packageId Primary key to uniquely identify a Box Package. PackageId must be provided if the intent is to update an existing box. Adding a new box will not require providing this value. Any existing PackageIds not provided will be treated as to-be-removed
     *
     * @return self
     */
    public function setPackageId($packageId)
    {
        if (!is_null($packageId) && (mb_strlen($packageId) > 38)) {
            throw new \InvalidArgumentException('invalid length for $packageId when calling BoxUpdateInput20240320., must be smaller than or equal to 38.');
        }
        if (!is_null($packageId) && (mb_strlen($packageId) < 38)) {
            throw new \InvalidArgumentException('invalid length for $packageId when calling BoxUpdateInput20240320., must be bigger than or equal to 38.');
        }
        if (!is_null($packageId) && (!preg_match("/^[a-zA-Z0-9-]*$/", $packageId))) {
            throw new \InvalidArgumentException("invalid value for $packageId when calling BoxUpdateInput20240320., must conform to the pattern /^[a-zA-Z0-9-]*$/.");
        }
    ...
    {
        if (($quantity > 10000)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling BoxUpdateInput20240320., must be smaller than or equal to 10000.');
        }
        if (($quantity < 1)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling BoxUpdateInput20240320., must be bigger than or equal to 1.');
        }
