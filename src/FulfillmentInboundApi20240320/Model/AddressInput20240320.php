...
/**
 * AddressInput20240320 Class Doc Comment
 *
 * @category Class
 ...
 */
class AddressInput20240320 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['districtOrCounty']) && (mb_strlen($this->container['districtOrCounty']) > 50)) {
            $invalidProperties[] = "invalid value for 'districtOrCounty', the character length must be smaller than or equal to 50.";
        }

        if (!is_null($this->container['districtOrCounty']) && (mb_strlen($this->container['districtOrCounty']) < 1)) {
            $invalidProperties[] = "invalid value for 'districtOrCounty', the character length must be bigger than or equal to 1.";
        }
    ...
    public function setAddressLine1($addressLine1)
    {
        if ((mb_strlen($addressLine1) > 180)) {
            throw new \InvalidArgumentException('invalid length for $addressLine1 when calling AddressInput20240320., must be smaller than or equal to 180.');
        }
        if ((mb_strlen($addressLine1) < 1)) {
            throw new \InvalidArgumentException('invalid length for $addressLine1 when calling AddressInput20240320., must be bigger than or equal to 1.');
        }
    ...
    public function setAddressLine2($addressLine2)
    {
        if (!is_null($addressLine2) && (mb_strlen($addressLine2) > 60)) {
            throw new \InvalidArgumentException('invalid length for $addressLine2 when calling AddressInput20240320., must be smaller than or equal to 60.');
        }
        if (!is_null($addressLine2) && (mb_strlen($addressLine2) < 1)) {
            throw new \InvalidArgumentException('invalid length for $addressLine2 when calling AddressInput20240320., must be bigger than or equal to 1.');
        }
    ...
    public function setCity($city)
    {
        if ((mb_strlen($city) > 30)) {
            throw new \InvalidArgumentException('invalid length for $city when calling AddressInput20240320., must be smaller than or equal to 30.');
        }
        if ((mb_strlen($city) < 1)) {
            throw new \InvalidArgumentException('invalid length for $city when calling AddressInput20240320., must be bigger than or equal to 1.');
        }
    ...
    public function setCompanyName($companyName)
    {
        if (!is_null($companyName) && (mb_strlen($companyName) > 50)) {
            throw new \InvalidArgumentException('invalid length for $companyName when calling AddressInput20240320., must be smaller than or equal to 50.');
        }
        if (!is_null($companyName) && (mb_strlen($companyName) < 1)) {
            throw new \InvalidArgumentException('invalid length for $companyName when calling AddressInput20240320., must be bigger than or equal to 1.');
        }
    ...
    public function setCountryCode($countryCode)
    {
        if ((mb_strlen($countryCode) > 2)) {
            throw new \InvalidArgumentException('invalid length for $countryCode when calling AddressInput20240320., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($countryCode) < 2)) {
            throw new \InvalidArgumentException('invalid length for $countryCode when calling AddressInput20240320., must be bigger than or equal to 2.');
        }
        if ((!preg_match("/^[A-Z]{2}$/", $countryCode))) {
            throw new \InvalidArgumentException("invalid value for $countryCode when calling AddressInput20240320., must conform to the pattern /^[A-Z]{2}$/.");
        }
    ...
    {
        if (!is_null($districtOrCounty) && (mb_strlen($districtOrCounty) > 50)) {
            throw new \InvalidArgumentException('invalid length for $districtOrCounty when calling AddressInput20240320., must be smaller than or equal to 50.');
        }
        if (!is_null($districtOrCounty) && (mb_strlen($districtOrCounty) < 1)) {
            throw new \InvalidArgumentException('invalid length for $districtOrCounty when calling AddressInput20240320., must be bigger than or equal to 1.');
        }
    ...
    public function setEmail($email)
    {
        if (!is_null($email) && (mb_strlen($email) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $email when calling AddressInput20240320., must be smaller than or equal to 1024.');
        }
        if (!is_null($email) && (mb_strlen($email) < 1)) {
            throw new \InvalidArgumentException('invalid length for $email when calling AddressInput20240320., must be bigger than or equal to 1.');
        }
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $name when calling AddressInput20240320., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling AddressInput20240320., must be bigger than or equal to 1.');
        }
    ...
    public function setPhoneNumber($phoneNumber)
    {
        if ((mb_strlen($phoneNumber) > 20)) {
            throw new \InvalidArgumentException('invalid length for $phoneNumber when calling AddressInput20240320., must be smaller than or equal to 20.');
        }
        if ((mb_strlen($phoneNumber) < 1)) {
            throw new \InvalidArgumentException('invalid length for $phoneNumber when calling AddressInput20240320., must be bigger than or equal to 1.');
        }
    ...
    public function setPostalCode($postalCode)
    {
        if ((mb_strlen($postalCode) > 32)) {
            throw new \InvalidArgumentException('invalid length for $postalCode when calling AddressInput20240320., must be smaller than or equal to 32.');
        }
        if ((mb_strlen($postalCode) < 1)) {
            throw new \InvalidArgumentException('invalid length for $postalCode when calling AddressInput20240320., must be bigger than or equal to 1.');
        }
    ...
    public function setStateOrProvinceCode($stateOrProvinceCode)
    {
        if (!is_null($stateOrProvinceCode) && (mb_strlen($stateOrProvinceCode) > 64)) {
            throw new \InvalidArgumentException('invalid length for $stateOrProvinceCode when calling AddressInput20240320., must be smaller than or equal to 64.');
        }
        if (!is_null($stateOrProvinceCode) && (mb_strlen($stateOrProvinceCode) < 1)) {
            throw new \InvalidArgumentException('invalid length for $stateOrProvinceCode when calling AddressInput20240320., must be bigger than or equal to 1.');
        }
