...
class GenerateTransportationOptionsRequest20240320 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setPlacementOptionId($placementOptionId)
    {
        if ((mb_strlen($placementOptionId) > 38)) {
            throw new \InvalidArgumentException('invalid length for $placementOptionId when calling GenerateTransportationOptionsRequest20240320., must be smaller than or equal to 38.');
        }
        if ((mb_strlen($placementOptionId) < 38)) {
            throw new \InvalidArgumentException('invalid length for $placementOptionId when calling GenerateTransportationOptionsRequest20240320., must be bigger than or equal to 38.');
        }
        if ((!preg_match("/^[a-zA-Z0-9-]*$/", $placementOptionId))) {
            throw new \InvalidArgumentException("invalid value for $placementOptionId when calling GenerateTransportationOptionsRequest20240320., must conform to the pattern /^[a-zA-Z0-9-]*$/.");
        }
