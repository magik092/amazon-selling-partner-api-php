...
/**
 * ShipmentSummary20240320 Class Doc Comment
 *
 * @category Class
 ...
 */
class ShipmentSummary20240320 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setShipmentId($shipmentId)
    {
        if ((mb_strlen($shipmentId) > 38)) {
            throw new \InvalidArgumentException('invalid length for $shipmentId when calling ShipmentSummary20240320., must be smaller than or equal to 38.');
        }
        if ((mb_strlen($shipmentId) < 38)) {
            throw new \InvalidArgumentException('invalid length for $shipmentId when calling ShipmentSummary20240320., must be bigger than or equal to 38.');
        }
        if ((!preg_match("/^[a-zA-Z0-9-]*$/", $shipmentId))) {
            throw new \InvalidArgumentException("invalid value for $shipmentId when calling ShipmentSummary20240320., must conform to the pattern /^[a-zA-Z0-9-]*$/.");
        }
    ...
    public function setStatus($status)
    {
        if ((mb_strlen($status) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $status when calling ShipmentSummary20240320., must be smaller than or equal to 1024.');
        }
        if ((mb_strlen($status) < 1)) {
            throw new \InvalidArgumentException('invalid length for $status when calling ShipmentSummary20240320., must be bigger than or equal to 1.');
        }
