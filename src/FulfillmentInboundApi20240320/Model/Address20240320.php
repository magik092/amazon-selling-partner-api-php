...
class Address20240320 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setDistrictOrCounty($districtOrCounty)
    {
        if (!is_null($districtOrCounty) && (mb_strlen($districtOrCounty) > 50)) {
            throw new \InvalidArgumentException('invalid length for $districtOrCounty when calling Address20240320., must be smaller than or equal to 50.');
        }
        if (!is_null($districtOrCounty) && (mb_strlen($districtOrCounty) < 1)) {
            throw new \InvalidArgumentException('invalid length for $districtOrCounty when calling Address20240320., must be bigger than or equal to 1.');
        }
