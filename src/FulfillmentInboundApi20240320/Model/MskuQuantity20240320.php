...
/**
 * MskuQuantity20240320 Class Doc Comment
 *
 * @category Class
 ...
 */
class MskuQuantity20240320 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setMsku($msku)
    {
        if ((mb_strlen($msku) > 255)) {
            throw new \InvalidArgumentException('invalid length for $msku when calling MskuQuantity20240320., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($msku) < 1)) {
            throw new \InvalidArgumentException('invalid length for $msku when calling MskuQuantity20240320., must be bigger than or equal to 1.');
        }
    ...
    public function setQuantity($quantity)
    {
        ...
        if (($quantity > 10000)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling MskuQuantity20240320., must be smaller than or equal to 10000.');
        }
        if (($quantity < 1)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling MskuQuantity20240320., must be bigger than or equal to 1.');
        }
