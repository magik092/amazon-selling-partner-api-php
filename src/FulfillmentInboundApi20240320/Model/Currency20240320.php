...
/**
 * Currency20240320 Class Doc Comment
 *
 * @category Class
 ...
 */
class Currency20240320 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        if ((mb_strlen($code) > 3)) {
            throw new \InvalidArgumentException('invalid length for $code when calling Currency20240320., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($code) < 3)) {
            throw new \InvalidArgumentException('invalid length for $code when calling Currency20240320., must be bigger than or equal to 3.');
        }
