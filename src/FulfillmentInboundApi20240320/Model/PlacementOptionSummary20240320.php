<?php
/**
 * PlacementOptionSummary20240320
 *
 * PHP version 7.2
 *
 * @category Class
...
/**
 * PlacementOptionSummary20240320 Class Doc Comment
 *
 * @category Class
 ...
 */
class PlacementOptionSummary20240320 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setPlacementOptionId($placementOptionId)
    {
        if ((mb_strlen($placementOptionId) > 38)) {
            throw new \InvalidArgumentException('invalid length for $placementOptionId when calling PlacementOptionSummary20240320., must be smaller than or equal to 38.');
        }
        if ((mb_strlen($placementOptionId) < 38)) {
            throw new \InvalidArgumentException('invalid length for $placementOptionId when calling PlacementOptionSummary20240320., must be bigger than or equal to 38.');
        }
        if ((!preg_match("/^[a-zA-Z0-9-]*$/", $placementOptionId))) {
            throw new \InvalidArgumentException("invalid value for $placementOptionId when calling PlacementOptionSummary20240320., must conform to the pattern /^[a-zA-Z0-9-]*$/.");
        }
    ...
    public function setStatus($status)
    {
        if ((mb_strlen($status) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $status when calling PlacementOptionSummary20240320., must be smaller than or equal to 1024.');
        }
        if ((mb_strlen($status) < 1)) {
            throw new \InvalidArgumentException('invalid length for $status when calling PlacementOptionSummary20240320., must be bigger than or equal to 1.');
        }
