...
/**
 * Incentive20240320 Class Doc Comment
 *
 * @category Class
 ...
 */
class Incentive20240320 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'target'      => 'string',
        'type'        => 'string',
        'value'       => '\Webcom\Amazon\Rest\FulfillmentInboundApi20240320\Model\Currency20240320',
    ];
    /**
    ...
    public function setDescription($description)
    {
        if ((mb_strlen($description) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $description when calling Incentive20240320., must be smaller than or equal to 1024.');
        }
        if ((mb_strlen($description) < 1)) {
            throw new \InvalidArgumentException('invalid length for $description when calling Incentive20240320., must be bigger than or equal to 1.');
        }
    ...
    public function setTarget($target)
    {
        if ((mb_strlen($target) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $target when calling Incentive20240320., must be smaller than or equal to 1024.');
        }
        if ((mb_strlen($target) < 1)) {
            throw new \InvalidArgumentException('invalid length for $target when calling Incentive20240320., must be bigger than or equal to 1.');
        }
    ...
    public function setType($type)
    {
        if ((mb_strlen($type) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $type when calling Incentive20240320., must be smaller than or equal to 1024.');
        }
        if ((mb_strlen($type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $type when calling Incentive20240320., must be bigger than or equal to 1.');
        }
     ...
     * Sets value
     *
     * @param \Webcom\Amazon\Rest\FulfillmentInboundApi20240320\Model\Currency20240320 $value value
     *
     * @return self
     */
