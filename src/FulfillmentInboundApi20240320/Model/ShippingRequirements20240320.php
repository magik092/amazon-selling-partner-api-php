...
/**
 * ShippingRequirements20240320 Class Doc Comment
 *
 * @category Class
 ...
 */
class ShippingRequirements20240320 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setSolution($solution)
    {
        if ((mb_strlen($solution) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $solution when calling ShippingRequirements20240320., must be smaller than or equal to 1024.');
        }
        if ((mb_strlen($solution) < 1)) {
            throw new \InvalidArgumentException('invalid length for $solution when calling ShippingRequirements20240320., must be bigger than or equal to 1.');
        }
