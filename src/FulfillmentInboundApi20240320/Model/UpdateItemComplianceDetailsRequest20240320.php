<?php
/**
 * UpdateItemComplianceDetailsRequest20240320
 *
 * PHP version 7.2
 *
 * @category Class
...
/**
 * UpdateItemComplianceDetailsRequest20240320 Class Doc Comment
 *
 * @category Class
 ...
 */
class UpdateItemComplianceDetailsRequest20240320 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setMsku($msku)
    {
        if ((mb_strlen($msku) > 255)) {
            throw new \InvalidArgumentException('invalid length for $msku when calling UpdateItemComplianceDetailsRequest20240320., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($msku) < 1)) {
            throw new \InvalidArgumentException('invalid length for $msku when calling UpdateItemComplianceDetailsRequest20240320., must be bigger than or equal to 1.');
        }
     ...
     * Gets taxDetails
     *
     * @return \Webcom\Amazon\Rest\FulfillmentInboundApi20240320\Model\TaxDetails20240320
     */
     ...
     * Sets taxDetails
     *
     * @param \Webcom\Amazon\Rest\FulfillmentInboundApi20240320\Model\TaxDetails20240320 $taxDetails taxDetails
     *
     * @return self
     */
