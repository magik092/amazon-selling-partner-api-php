<?php
/**
 * OfferProgramConfigurationPromotionsDiscountFunding20221107
 *
 * PHP version 7.2
 *
 * @category Class
...
/**
 * OfferProgramConfigurationPromotionsDiscountFunding20221107 Class Doc Comment
 *
 * @category Class
 ...
 */
class OfferProgramConfigurationPromotionsDiscountFunding20221107 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setPercentage($percentage)
    {
        ...
        if (!is_null($percentage) && ($percentage > 1E+2)) {
            throw new \InvalidArgumentException('invalid value for $percentage when calling OfferProgramConfigurationPromotionsDiscountFunding20221107., must be smaller than or equal to 1E+2.');
        }
        if (!is_null($percentage) && ($percentage < 0)) {
            throw new \InvalidArgumentException('invalid value for $percentage when calling OfferProgramConfigurationPromotionsDiscountFunding20221107., must be bigger than or equal to 0.');
        }
