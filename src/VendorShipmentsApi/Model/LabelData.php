...
class LabelData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['labelSequenceNumber'] = $data['labelSequenceNumber'] ?? null;
     ...
     *
     * @param int|null $labelSequenceNumber A sequential number assigned to each label within a shipment.
     *
     * @return self
     */
     ...
     * Sets labelFormat
     *
     * @param string|null $labelFormat The format of the label.
     *
     * @return self
     */
     ...
     * Sets carrierCode
     *
     * @param string|null $carrierCode Unique identification of the carrier.
     *
     * @return self
     */
     ...
     * Sets trackingId
     *
     * @param string|null $trackingId Tracking Id for the transportation.
     *
     * @return self
     */
