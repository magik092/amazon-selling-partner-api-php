...
class ShipmentStatusDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['shipmentStatusDate'] = $data['shipmentStatusDate'] ?? null;
    }
     ...
     * Sets shipmentStatus
     *
     * @param string|null $shipmentStatus Current status of the shipment on whether it is picked up or scheduled.
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $shipmentStatusDate Date and time on last status update received for the shipment
     *
     * @return self
     */
