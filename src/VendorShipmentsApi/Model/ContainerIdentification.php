...
class ContainerIdentification implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['containerIdentificationType'] = $data['containerIdentificationType'] ?? null;
        $this->container['containerIdentificationNumber'] = $data['containerIdentificationNumber'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['containerIdentificationType']) && !in_array($this->container['containerIdentificationType'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'containerIdentificationType', must be one of '%s'",
                $this->container['containerIdentificationType'],
