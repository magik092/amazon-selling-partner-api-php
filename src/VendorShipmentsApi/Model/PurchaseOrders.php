...
class PurchaseOrders implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'shipWindow' => 'string',
        'items' => '\Webcom\Amazon\Rest\VendorShipmentsApi\Model\PurchaseOrderItems[]'
    ];
     ...
     *
     * @param string|null $purchaseOrderNumber Purchase order numbers involved in this shipment, list all the PO that are involved as part of this shipment.
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $purchaseOrderDate Purchase order numbers involved in this shipment, list all the PO that are involved as part of this shipment.
     *
     * @return self
     */
     ...
     * Sets shipWindow
     *
     * @param string|null $shipWindow Date range in which shipment is expected for these purchase orders.
     *
     * @return self
     */
     ...
     * Gets items
     *
     * @return \Webcom\Amazon\Rest\VendorShipmentsApi\Model\PurchaseOrderItems[]|null
     */
     ...
     * Sets items
     *
     * @param \Webcom\Amazon\Rest\VendorShipmentsApi\Model\PurchaseOrderItems[]|null $items A list of the items that are associated to the PO in this transport and their associated details.
     *
     * @return self
     */
