...
class CarrierDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['shipmentReferenceNumber'] = $data['shipmentReferenceNumber'] ?? null;
    }
     ...
     *
     * @param string|null $shipmentReferenceNumber The field is also known as PRO number is a unique number assigned by the carrier. It is used to identify and track the shipment that goes out for delivery. This field is mandatory for US, CA, MX shipment confirmations.
     *
     * @return self
     */
