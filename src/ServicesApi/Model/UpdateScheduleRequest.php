...
class UpdateScheduleRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'schedules' => '\Webcom\Amazon\Rest\ServicesApi\Model\AvailabilityRecord[]'
    ];
     ...
     * Sets schedules
     *
     * @param \Webcom\Amazon\Rest\ServicesApi\Model\AvailabilityRecord[] $schedules List of `AvailabilityRecord`s to represent the capacity of a resource over a time range.
     *
     * @return self
     */
