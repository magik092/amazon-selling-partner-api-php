 ...
 */
class AdditionalDetailsV1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets languageCode
     *
     * @param string|null $languageCode The language code of the additional information detail.
     *
     * @return self
     */
