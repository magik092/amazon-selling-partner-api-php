...
/**
 * InvoiceData20220323 Class Doc Comment
 *
 * @category Class
 ...
 */
class InvoiceData20220323 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['invoiceNumber']) > 255)) {
    ...
    {
        if ((mb_strlen($invoiceNumber) > 255)) {
            throw new \InvalidArgumentException('invalid length for $invoiceNumber when calling InvoiceData20220323., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($invoiceNumber) < 1)) {
            throw new \InvalidArgumentException('invalid length for $invoiceNumber when calling InvoiceData20220323., must be bigger than or equal to 1.');
        }
     ...
     * Sets invoiceDate
     *
     * @param \DateTime|null $invoiceDate A datetime value in ISO 8601 format.
     *
     * @return self
     */
