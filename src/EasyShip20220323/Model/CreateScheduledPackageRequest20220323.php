<?php
/**
 * CreateScheduledPackageRequest20220323
 *
 * PHP version 7.2
 *
 * @category Class
...
/**
 * CreateScheduledPackageRequest20220323 Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateScheduledPackageRequest20220323 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setMarketplaceId($marketplaceId)
    {
        if ((mb_strlen($marketplaceId) > 255)) {
            throw new \InvalidArgumentException('invalid length for $marketplaceId when calling CreateScheduledPackageRequest20220323., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($marketplaceId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $marketplaceId when calling CreateScheduledPackageRequest20220323., must be bigger than or equal to 1.');
        }
     ...
     * Gets packageDetails
     *
     * @return \Webcom\Amazon\Rest\EasyShip20220323\Model\PackageDetails20220323
     */
     ...
     * Sets packageDetails
     *
     * @param \Webcom\Amazon\Rest\EasyShip20220323\Model\PackageDetails20220323 $packageDetails packageDetails
     *
     * @return self
     */
