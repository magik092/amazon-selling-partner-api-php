<?php
/**
 * ListHandoverSlotsRequest20220323
 *
 * PHP version 7.2
 *
 * @category Class
...
/**
 * ListHandoverSlotsRequest20220323 Class Doc Comment
 *
 * @category Class
 ...
 */
class ListHandoverSlotsRequest20220323 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setMarketplaceId($marketplaceId)
    {
        if ((mb_strlen($marketplaceId) > 255)) {
            throw new \InvalidArgumentException('invalid length for $marketplaceId when calling ListHandoverSlotsRequest20220323., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($marketplaceId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $marketplaceId when calling ListHandoverSlotsRequest20220323., must be bigger than or equal to 1.');
        }
