 ...
 */
class ShippingLabelV1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'labelFormat' => 'string',
        'labelData' => '\Webcom\Amazon\Rest\VendorDirectFulfillmentShippingApiV1\Model\LabelDataV1[]'
    ];
    ...
    public function setPurchaseOrderNumber($purchaseOrderNumber)
    {
        ...
        if ((!preg_match("/^[a-zA-Z0-9]+$/", $purchaseOrderNumber))) {
            throw new \InvalidArgumentException("invalid value for $purchaseOrderNumber when calling ShippingLabelV1., must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
     ...
     * Gets labelData
     *
     * @return \Webcom\Amazon\Rest\VendorDirectFulfillmentShippingApiV1\Model\LabelDataV1[]
     */
     ...
     * Sets labelData
     *
     * @param \Webcom\Amazon\Rest\VendorDirectFulfillmentShippingApiV1\Model\LabelDataV1[] $labelData Provides the details of the packages in this shipment.
     *
     * @return self
     */
