...
/**
 * ShipmentStatusUpdateV1 Class Doc Comment
 *
 * @category Class
 ...
 */
class ShipmentStatusUpdateV1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'statusUpdateDetails' => '\Webcom\Amazon\Rest\VendorDirectFulfillmentShippingApiV1\Model\StatusUpdateDetailsV1'
    ];
    ...
    public function setPurchaseOrderNumber($purchaseOrderNumber)
    {
        ...
        if ((!preg_match("/^[a-zA-Z0-9]+$/", $purchaseOrderNumber))) {
            throw new \InvalidArgumentException("invalid value for $purchaseOrderNumber when calling ShipmentStatusUpdateV1., must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
     ...
     *
     * @return \Webcom\Amazon\Rest\VendorDirectFulfillmentShippingApiV1\Model\StatusUpdateDetailsV1
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\VendorDirectFulfillmentShippingApiV1\Model\StatusUpdateDetailsV1 $statusUpdateDetails statusUpdateDetails
     *
     * @return self
     */
