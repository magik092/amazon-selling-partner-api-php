 ...
 */
class ShipmentConfirmationV1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'shipmentDetails' => '\Webcom\Amazon\Rest\VendorDirectFulfillmentShippingApiV1\Model\ShipmentDetailsV1',
        'sellingParty' => '\Webcom\Amazon\Rest\VendorDirectFulfillmentShippingApiV1\Model\PartyIdentificationV1',
        'shipFromParty' => '\Webcom\Amazon\Rest\VendorDirectFulfillmentShippingApiV1\Model\PartyIdentificationV1',
        'items' => '\Webcom\Amazon\Rest\VendorDirectFulfillmentShippingApiV1\Model\ItemV1[]',
        'containers' => '\Webcom\Amazon\Rest\VendorDirectFulfillmentShippingApiV1\Model\ContainerV1[]'
    ];
    ...
    public function setPurchaseOrderNumber($purchaseOrderNumber)
    {
        ...
        if ((!preg_match("/^[a-zA-Z0-9]+$/", $purchaseOrderNumber))) {
            throw new \InvalidArgumentException("invalid value for $purchaseOrderNumber when calling ShipmentConfirmationV1., must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
     ...
     *
     * @return \Webcom\Amazon\Rest\VendorDirectFulfillmentShippingApiV1\Model\ShipmentDetailsV1
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\VendorDirectFulfillmentShippingApiV1\Model\ShipmentDetailsV1 $shipmentDetails shipmentDetails
     *
     * @return self
     */
     ...
     * Gets sellingParty
     *
     * @return \Webcom\Amazon\Rest\VendorDirectFulfillmentShippingApiV1\Model\PartyIdentificationV1
     */
     ...
     * Sets sellingParty
     *
     * @param \Webcom\Amazon\Rest\VendorDirectFulfillmentShippingApiV1\Model\PartyIdentificationV1 $sellingParty sellingParty
     *
     * @return self
     */
     ...
     * Sets shipFromParty
     *
     * @param \Webcom\Amazon\Rest\VendorDirectFulfillmentShippingApiV1\Model\PartyIdentificationV1 $shipFromParty shipFromParty
     *
     * @return self
     */
     ...
     * Gets items
     *
     * @return \Webcom\Amazon\Rest\VendorDirectFulfillmentShippingApiV1\Model\ItemV1[]
     */
     ...
     * Sets items
     *
     * @param \Webcom\Amazon\Rest\VendorDirectFulfillmentShippingApiV1\Model\ItemV1[] $items Provide the details of the items in this shipment. If any of the item details field is common at a package or a pallet level, then provide them at the corresponding package.
     *
     * @return self
     */
     ...
     * Gets containers
     *
     * @return \Webcom\Amazon\Rest\VendorDirectFulfillmentShippingApiV1\Model\ContainerV1[]|null
     */
     ...
     * Sets containers
     *
     * @param \Webcom\Amazon\Rest\VendorDirectFulfillmentShippingApiV1\Model\ContainerV1[]|null $containers Provide the details of the items in this shipment. If any of the item details field is common at a package or a pallet level, then provide them at the corresponding package.
     *
     * @return self
     */
