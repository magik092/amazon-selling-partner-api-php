...
/**
 * ShippingLabelRequestV1 Class Doc Comment
 *
 * @category Class
 ...
 */
class ShippingLabelRequestV1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setPurchaseOrderNumber($purchaseOrderNumber)
    {
        ...
        if ((!preg_match("/^[a-zA-Z0-9]+$/", $purchaseOrderNumber))) {
            throw new \InvalidArgumentException("invalid value for $purchaseOrderNumber when calling ShippingLabelRequestV1., must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
     ...
     * Sets containers
     *
     * @param \Webcom\Amazon\Rest\VendorDirectFulfillmentShippingApiV1\Model\ContainerV1[]|null $containers A list of the packages in this shipment.
     *
     * @return self
     */
