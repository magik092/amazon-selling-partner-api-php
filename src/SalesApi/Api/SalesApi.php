...
namespace Webcom\Amazon\Rest\SalesApi\Api;
...
use Webcom\Amazon\Rest\SalesApi\ApiException;
...
class SalesApi
{
    ...
    public function getOrderMetricsWithHttpInfo($marketplaceIds, $interval, $granularity, $granularityTimeZone = null, $buyerType = 'All', $fulfillmentNetwork = null, $firstDayOfWeek = 'Monday', $asin = null, $sku = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Webcom\Amazon\Rest\SalesApi\Model\GetOrderMetricsResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Webcom\Amazon\Rest\SalesApi\Model\GetOrderMetricsResponse', []),
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Webcom\Amazon\Rest\SalesApi\Model\GetOrderMetricsResponse',
    ...
    public function getOrderMetricsRequest($marketplaceIds, $interval, $granularity, $granularityTimeZone = null, $buyerType = 'All', $fulfillmentNetwork = null, $firstDayOfWeek = 'Monday', $asin = null, $sku = null)
    {
        ...
        // query params
        if (is_array($granularityTimeZone)) {
            $granularityTimeZone = ObjectSerializer::serializeCollection($granularityTimeZone, '', true);
        }
        if ($granularityTimeZone !== null) {
            $queryParams['granularityTimeZone'] = $granularityTimeZone;
        }
        // query params
        ...
        // query params
        if (is_array($buyerType)) {
            $buyerType = ObjectSerializer::serializeCollection($buyerType, '', true);
        }
        if ($buyerType !== null) {
            $queryParams['buyerType'] = $buyerType;
        }
        // query params
        if (is_array($fulfillmentNetwork)) {
            $fulfillmentNetwork = ObjectSerializer::serializeCollection($fulfillmentNetwork, '', true);
        }
        if ($fulfillmentNetwork !== null) {
            $queryParams['fulfillmentNetwork'] = $fulfillmentNetwork;
        }
        // query params
        if (is_array($firstDayOfWeek)) {
            $firstDayOfWeek = ObjectSerializer::serializeCollection($firstDayOfWeek, '', true);
        }
        if ($firstDayOfWeek !== null) {
            $queryParams['firstDayOfWeek'] = $firstDayOfWeek;
        }
        // query params
        if (is_array($asin)) {
