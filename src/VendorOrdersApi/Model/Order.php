...
class Order implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'orderDetails' => '\Webcom\Amazon\Rest\VendorOrdersApi\Model\OrderDetails'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['purchaseOrderState'] = $data['purchaseOrderState'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['purchaseOrderState']) && !in_array($this->container['purchaseOrderState'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'purchaseOrderState', must be one of '%s'",
                $this->container['purchaseOrderState'],
     ...
     * Gets orderDetails
     *
     * @return \Webcom\Amazon\Rest\VendorOrdersApi\Model\OrderDetails|null
     */
     ...
     * Sets orderDetails
     *
     * @param \Webcom\Amazon\Rest\VendorOrdersApi\Model\OrderDetails|null $orderDetails orderDetails
     *
     * @return self
     */
