...
class Pagination implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets nextToken
     *
     * @param string|null $nextToken A generated string used to pass information to your next request. If NextToken is returned, pass the value of NextToken to the next request. If NextToken is not returned, there are no more purchase order items to return.
     *
     * @return self
     */
