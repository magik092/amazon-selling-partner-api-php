...
class OrderedQuantityDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'cancelledQuantity' => '\Webcom\Amazon\Rest\VendorOrdersApi\Model\ItemQuantity'
    ];
    ...
    {
        $this->container['updatedDate'] = $data['updatedDate'] ?? null;
     ...
     * Sets updatedDate
     *
     * @param \DateTime|null $updatedDate The date when the line item quantity was updated by buyer. Must be in ISO-8601 date/time format.
     *
     * @return self
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\VendorOrdersApi\Model\ItemQuantity|null $orderedQuantity orderedQuantity
     *
     * @return self
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\VendorOrdersApi\Model\ItemQuantity|null $cancelledQuantity cancelledQuantity
     *
     * @return self
     */
