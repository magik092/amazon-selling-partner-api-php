 ...
 */
class Decorator20201101 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'type' => '\Webcom\Amazon\Rest\AplusContentApi20201101\Model\DecoratorType20201101',
        'offset' => 'int',
        'length' => 'int',
        'depth' => 'int'
    ];
     ...
     * Gets type
     *
     * @return \Webcom\Amazon\Rest\AplusContentApi20201101\Model\DecoratorType20201101|null
     */
     ...
     * Sets type
     *
     * @param \Webcom\Amazon\Rest\AplusContentApi20201101\Model\DecoratorType20201101|null $type type
     *
     * @return self
     */
    ...
    public function setOffset($offset)
    {
        ...
        if (!is_null($offset) && ($offset > 10000)) {
            throw new \InvalidArgumentException('invalid value for $offset when calling Decorator20201101., must be smaller than or equal to 10000.');
        }
        if (!is_null($offset) && ($offset < 0)) {
            throw new \InvalidArgumentException('invalid value for $offset when calling Decorator20201101., must be bigger than or equal to 0.');
        }
    ...
    public function setLength($length)
    {
        ...
        if (!is_null($length) && ($length > 10000)) {
            throw new \InvalidArgumentException('invalid value for $length when calling Decorator20201101., must be smaller than or equal to 10000.');
        }
        if (!is_null($length) && ($length < 0)) {
            throw new \InvalidArgumentException('invalid value for $length when calling Decorator20201101., must be bigger than or equal to 0.');
        }
    ...
    public function setDepth($depth)
    {
        ...
        if (!is_null($depth) && ($depth > 100)) {
            throw new \InvalidArgumentException('invalid value for $depth when calling Decorator20201101., must be smaller than or equal to 100.');
        }
        if (!is_null($depth) && ($depth < 0)) {
            throw new \InvalidArgumentException('invalid value for $depth when calling Decorator20201101., must be bigger than or equal to 0.');
        }
