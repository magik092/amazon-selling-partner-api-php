<?php
/**
 * StandardTechSpecsModule20201101
 *
 * PHP version 7.2
 *
 * @category Class
...
/**
 * StandardTechSpecsModule20201101 Class Doc Comment
 *
 * @category Class
 ...
 */
class StandardTechSpecsModule20201101 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'specificationList' => '\Webcom\Amazon\Rest\AplusContentApi20201101\Model\StandardTextPairBlock20201101[]',
        'tableCount' => 'int'
    ];
     ...
     *
     * @return \Webcom\Amazon\Rest\AplusContentApi20201101\Model\StandardTextPairBlock20201101[]
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\AplusContentApi20201101\Model\StandardTextPairBlock20201101[] $specificationList The specification list.
     *
     * @return self
     */
     ...
     * Sets tableCount
     *
     * @param int|null $tableCount The number of tables you want present. Features are evenly divided between the tables.
     *
     * @return self
     */
    public function setTableCount($tableCount)
    {
        ...
        if (!is_null($tableCount) && ($tableCount > 2)) {
            throw new \InvalidArgumentException('invalid value for $tableCount when calling StandardTechSpecsModule20201101., must be smaller than or equal to 2.');
        }
        if (!is_null($tableCount) && ($tableCount < 1)) {
            throw new \InvalidArgumentException('invalid value for $tableCount when calling StandardTechSpecsModule20201101., must be bigger than or equal to 1.');
        }
