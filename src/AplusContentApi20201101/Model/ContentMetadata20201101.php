 ...
 */
class ContentMetadata20201101 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'status' => '\Webcom\Amazon\Rest\AplusContentApi20201101\Model\ContentStatus20201101',
        'badgeSet' => '\Webcom\Amazon\Rest\AplusContentApi20201101\Model\ContentBadge20201101[]',
        'updateTime' => '\DateTime'
    ];
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ContentMetadata20201101., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ContentMetadata20201101., must be bigger than or equal to 1.');
        }
    ...
    public function setMarketplaceId($marketplaceId)
    {
        ...
        if ((mb_strlen($marketplaceId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $marketplaceId when calling ContentMetadata20201101., must be bigger than or equal to 1.');
        }
     ...
     * Gets status
     *
     * @return \Webcom\Amazon\Rest\AplusContentApi20201101\Model\ContentStatus20201101
     */
     ...
     * Sets status
     *
     * @param \Webcom\Amazon\Rest\AplusContentApi20201101\Model\ContentStatus20201101 $status status
     *
     * @return self
     */
     ...
     * Gets badgeSet
     *
     * @return \Webcom\Amazon\Rest\AplusContentApi20201101\Model\ContentBadge20201101[]
     */
     ...
     * Sets badgeSet
     *
     * @param \Webcom\Amazon\Rest\AplusContentApi20201101\Model\ContentBadge20201101[] $badgeSet The set of content badges.
     *
     * @return self
     */
