...
/**
 * ImageComponent20201101 Class Doc Comment
 *
 * @category Class
 ...
 */
class ImageComponent20201101 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'imageCropSpecification' => '\Webcom\Amazon\Rest\AplusContentApi20201101\Model\ImageCropSpecification20201101',
        'altText' => 'string'
    ];
    ...
    public function setUploadDestinationId($uploadDestinationId)
    {
        ...
        if ((mb_strlen($uploadDestinationId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $uploadDestinationId when calling ImageComponent20201101., must be bigger than or equal to 1.');
        }
     ...
     *
     * @return \Webcom\Amazon\Rest\AplusContentApi20201101\Model\ImageCropSpecification20201101
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\AplusContentApi20201101\Model\ImageCropSpecification20201101 $imageCropSpecification imageCropSpecification
     *
     * @return self
     */
    ...
    public function setAltText($altText)
    {
        if ((mb_strlen($altText) > 100)) {
            throw new \InvalidArgumentException('invalid length for $altText when calling ImageComponent20201101., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($altText) < 1)) {
            throw new \InvalidArgumentException('invalid length for $altText when calling ImageComponent20201101., must be bigger than or equal to 1.');
        }
