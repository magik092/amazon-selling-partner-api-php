<?php
/**
 * PostContentDocumentResponseAllOf20201101
 *
 * PHP version 7.2
 *
 * @category Class
...
/**
 * PostContentDocumentResponseAllOf20201101 Class Doc Comment
 *
 * @category Class
 * @package  Webcom\Amazon\Rest\AplusContentApi20201101
 * @author   OpenAPI Generator team
 ...
 */
class PostContentDocumentResponseAllOf20201101 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setContentReferenceKey($contentReferenceKey)
    {
        ...
        if ((mb_strlen($contentReferenceKey) < 1)) {
            throw new \InvalidArgumentException('invalid length for $contentReferenceKey when calling PostContentDocumentResponseAllOf20201101., must be bigger than or equal to 1.');
        }
