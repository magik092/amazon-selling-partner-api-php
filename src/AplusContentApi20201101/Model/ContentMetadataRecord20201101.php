...
/**
 * ContentMetadataRecord20201101 Class Doc Comment
 *
 * @category Class
 ...
 */
class ContentMetadataRecord20201101 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setContentReferenceKey($contentReferenceKey)
    {
        ...
        if ((mb_strlen($contentReferenceKey) < 1)) {
            throw new \InvalidArgumentException('invalid length for $contentReferenceKey when calling ContentMetadataRecord20201101., must be bigger than or equal to 1.');
        }
     ...
     *
     * @return \Webcom\Amazon\Rest\AplusContentApi20201101\Model\ContentMetadata20201101
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\AplusContentApi20201101\Model\ContentMetadata20201101 $contentMetadata contentMetadata
     *
     * @return self
     */
