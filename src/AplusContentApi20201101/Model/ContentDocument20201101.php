...
/**
 * ContentDocument20201101 Class Doc Comment
 *
 * @category Class
 ...
 */
class ContentDocument20201101 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'locale' => 'string',
        'contentModuleList' => '\Webcom\Amazon\Rest\AplusContentApi20201101\Model\ContentModule20201101[]'
    ];
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ContentDocument20201101., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ContentDocument20201101., must be bigger than or equal to 1.');
        }
     ...
     * Sets contentSubType
     *
     * @param string|null $contentSubType The A+ Content document subtype. This represents a special-purpose type of an A+ Content document. Not every A+ Content document type has a subtype, and subtypes can change at any time.
     *
     * @return self
     */
    public function setContentSubType($contentSubType)
    {
        ...
        if (!is_null($contentSubType) && (mb_strlen($contentSubType) < 1)) {
            throw new \InvalidArgumentException('invalid length for $contentSubType when calling ContentDocument20201101., must be bigger than or equal to 1.');
        }
    ...
    public function setLocale($locale)
    {
        ...
        if ((mb_strlen($locale) < 5)) {
            throw new \InvalidArgumentException('invalid length for $locale when calling ContentDocument20201101., must be bigger than or equal to 5.');
        }
     ...
     *
     * @return \Webcom\Amazon\Rest\AplusContentApi20201101\Model\ContentModule20201101[]
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\AplusContentApi20201101\Model\ContentModule20201101[] $contentModuleList A list of A+ Content modules.
     *
     * @return self
     */
