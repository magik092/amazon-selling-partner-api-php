...
/**
 * AsinMetadata20201101 Class Doc Comment
 *
 * @category Class
 ...
 */
class AsinMetadata20201101 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'asin' => 'string',
        'badgeSet' => '\Webcom\Amazon\Rest\AplusContentApi20201101\Model\AsinBadge20201101[]',
        'parent' => 'string',
        'title' => 'string',
        'imageUrl' => 'string',
    ...
    public function setAsin($asin)
    {
        ...
        if ((mb_strlen($asin) < 10)) {
            throw new \InvalidArgumentException('invalid length for $asin when calling AsinMetadata20201101., must be bigger than or equal to 10.');
        }
     ...
     * Gets badgeSet
     *
     * @return \Webcom\Amazon\Rest\AplusContentApi20201101\Model\AsinBadge20201101[]|null
     */
     ...
     * Sets badgeSet
     *
     * @param \Webcom\Amazon\Rest\AplusContentApi20201101\Model\AsinBadge20201101[]|null $badgeSet The set of ASIN badges.
     *
     * @return self
     */
    ...
    public function setParent($parent)
    {
        ...
        if (!is_null($parent) && (mb_strlen($parent) < 10)) {
            throw new \InvalidArgumentException('invalid length for $parent when calling AsinMetadata20201101., must be bigger than or equal to 10.');
        }
    ...
    public function setTitle($title)
    {
        ...
        if (!is_null($title) && (mb_strlen($title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $title when calling AsinMetadata20201101., must be bigger than or equal to 1.');
        }
    ...
    public function setImageUrl($imageUrl)
    {
        ...
        if (!is_null($imageUrl) && (mb_strlen($imageUrl) < 1)) {
            throw new \InvalidArgumentException('invalid length for $imageUrl when calling AsinMetadata20201101., must be bigger than or equal to 1.');
        }
