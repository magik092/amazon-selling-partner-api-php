<?php
/**
 * AplusPaginatedResponseAllOf20201101
 *
 * PHP version 7.2
 *
 * @category Class
...
/**
 * AplusPaginatedResponseAllOf20201101 Class Doc Comment
 *
 * @category Class
 * @package  Webcom\Amazon\Rest\AplusContentApi20201101
 * @author   OpenAPI Generator team
 ...
 */
class AplusPaginatedResponseAllOf20201101 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setNextPageToken($nextPageToken)
    {
        ...
        if (!is_null($nextPageToken) && (mb_strlen($nextPageToken) < 1)) {
            throw new \InvalidArgumentException('invalid length for $nextPageToken when calling AplusPaginatedResponseAllOf20201101., must be bigger than or equal to 1.');
        }
