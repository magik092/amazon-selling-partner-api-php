<?php
/**
 * VariablePrecisionAddress20200701
 *
 * PHP version 7.2
 *
 * @category Class
...
/**
 * VariablePrecisionAddress20200701 Class Doc Comment
 *
 * @category Class
 ...
 */
class VariablePrecisionAddress20200701 implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param string|null $districtOrCounty The district or county where the person, business, or institution is located.
     *
     * @return self
     */
    ...
    public function setCountryCode($countryCode)
    {
        if ((mb_strlen($countryCode) > 2)) {
            throw new \InvalidArgumentException('invalid length for $countryCode when calling VariablePrecisionAddress20200701., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($countryCode) < 2)) {
            throw new \InvalidArgumentException('invalid length for $countryCode when calling VariablePrecisionAddress20200701., must be bigger than or equal to 2.');
        }
