<?php
/**
 * CreateFulfillmentOrderItem20200701
 *
 * PHP version 7.2
 *
 * @category Class
...
/**
 * CreateFulfillmentOrderItem20200701 Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateFulfillmentOrderItem20200701 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setSellerSku($sellerSku)
    {
        if ((mb_strlen($sellerSku) > 50)) {
            throw new \InvalidArgumentException('invalid length for $sellerSku when calling CreateFulfillmentOrderItem20200701., must be smaller than or equal to 50.');
        }
    ...
    public function setSellerFulfillmentOrderItemId($sellerFulfillmentOrderItemId)
    {
        if ((mb_strlen($sellerFulfillmentOrderItemId) > 50)) {
            throw new \InvalidArgumentException('invalid length for $sellerFulfillmentOrderItemId when calling CreateFulfillmentOrderItem20200701., must be smaller than or equal to 50.');
        }
    ...
    public function setGiftMessage($giftMessage)
    {
        if (!is_null($giftMessage) && (mb_strlen($giftMessage) > 512)) {
            throw new \InvalidArgumentException('invalid length for $giftMessage when calling CreateFulfillmentOrderItem20200701., must be smaller than or equal to 512.');
        }
    ...
    public function setDisplayableComment($displayableComment)
    {
        if (!is_null($displayableComment) && (mb_strlen($displayableComment) > 250)) {
            throw new \InvalidArgumentException('invalid length for $displayableComment when calling CreateFulfillmentOrderItem20200701., must be smaller than or equal to 250.');
        }
