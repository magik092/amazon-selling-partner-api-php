...
/**
 * CreateReturnItem20200701 Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateReturnItem20200701 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setSellerReturnItemId($sellerReturnItemId)
    {
        if ((mb_strlen($sellerReturnItemId) > 80)) {
            throw new \InvalidArgumentException('invalid length for $sellerReturnItemId when calling CreateReturnItem20200701., must be smaller than or equal to 80.');
        }
    ...
    public function setReturnComment($returnComment)
    {
        if (!is_null($returnComment) && (mb_strlen($returnComment) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $returnComment when calling CreateReturnItem20200701., must be smaller than or equal to 1000.');
        }
