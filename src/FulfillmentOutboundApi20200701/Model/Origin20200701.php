...
/**
 * Origin20200701 Class Doc Comment
 *
 * @category Class
 ...
 */
class Origin20200701 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setCountryCode($countryCode)
    {
        if ((mb_strlen($countryCode) > 2)) {
            throw new \InvalidArgumentException('invalid length for $countryCode when calling Origin20200701., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($countryCode) < 2)) {
            throw new \InvalidArgumentException('invalid length for $countryCode when calling Origin20200701., must be bigger than or equal to 2.');
        }
