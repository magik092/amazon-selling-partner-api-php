 ...
 */
class LabelDownloadURLV0 implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets downloadURL
     *
     * @param string|null $downloadURL URL to download the label for the package. Note: The URL will only be valid for 15 seconds
     *
     * @return self
     */
