...
/**
 * GetPreorderInfoResultV0 Class Doc Comment
 *
 * @category Class
 ...
 */
class GetPreorderInfoResultV0 implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets needByDate
     *
     * @param \DateTime|null $needByDate Type containing date in string format
     *
     * @return self
     */
