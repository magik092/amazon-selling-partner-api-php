<?php
/**
 * PartneredSmallParcelDataInputV0
 *
 * PHP version 7.2
 *
 * @category Class
...
/**
 * PartneredSmallParcelDataInputV0 Class Doc Comment
 *
 * @category Class
 ...
 */
class PartneredSmallParcelDataInputV0 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'packageList' => '\Webcom\Amazon\Rest\FulfillmentInboundApiV0\Model\PartneredSmallParcelPackageInputV0[]',
        'carrierName' => 'string'
    ];
     ...
     * Gets packageList
     *
     * @return \Webcom\Amazon\Rest\FulfillmentInboundApiV0\Model\PartneredSmallParcelPackageInputV0[]|null
     */
     ...
     * Sets packageList
     *
     * @param \Webcom\Amazon\Rest\FulfillmentInboundApiV0\Model\PartneredSmallParcelPackageInputV0[]|null $packageList A list of dimensions and weight information for packages.
     *
     * @return self
     */
