...
class AddressV0 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $name when calling AddressV0., must be smaller than or equal to 50.');
        }
    ...
    public function setDistrictOrCounty($districtOrCounty)
    {
        if (!is_null($districtOrCounty) && (mb_strlen($districtOrCounty) > 25)) {
            throw new \InvalidArgumentException('invalid length for $districtOrCounty when calling AddressV0., must be smaller than or equal to 25.');
        }
