...
/**
 * AssociatedOrderItem20260101 Class Doc Comment
 *
 * @category Class
 ...
 */
class AssociatedOrderItem20260101 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AssociatedOrderItem';
     ...
     * Sets orderId
     *
     * @param string|null $orderId The order identifier of the associated order item.
     *
     * @return self
     */
     ...
     * Sets orderItemId
     *
     * @param string|null $orderItemId The order item identifier of the associated order item.
     *
     * @return self
     */
     ...
     *
     * @param string|null $associationType The type of association between the order items.  **Possible values**: - `VALUE_ADD_SERVICE` (The associated item is a service order)
     *
     * @return self
     */
