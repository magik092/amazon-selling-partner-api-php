<?php
/**
 * SerialNumberRequirement20260101
 *
 * PHP version 7.2
 *
 * @category Class
...
/**
 * SerialNumberRequirement20260101 Class Doc Comment
 *
 * @category Class
 ...
 */
class SerialNumberRequirement20260101 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SerialNumberRequirement';
    ...
    {
        $this->container['requirementType'] = $data['requirementType'] ?? null;
    }
    ...
    {
        return $this->container['requirementType'];
    }

    /**
     * Sets requirementType
     *
     * @param string|null $requirementType The requirement type for this request.   **Possible values**: `REQUIRED`
     *
     * @return self
     */
    public function setRequirementType($requirementType)
    {
        $this->container['requirementType'] = $requirementType;
