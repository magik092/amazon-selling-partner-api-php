...
/**
 * GiftOption20260101 Class Doc Comment
 *
 * @category Class
 ...
 */
class GiftOption20260101 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GiftOption';
     ...
     * Sets giftMessage
     *
     * @param string|null $giftMessage Personal message from the buyer to be included with the gift-wrapped item.
     *
     * @return self
     */
     ...
     * Sets giftWrapLevel
     *
     * @param string|null $giftWrapLevel Type or quality level of gift wrapping service selected by the customer.
     *
     * @return self
     */
