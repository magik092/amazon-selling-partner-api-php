...
/**
 * BusinessHour20260101 Class Doc Comment
 *
 * @category Class
 ...
 */
class BusinessHour20260101 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BusinessHour';
    ...
    {
        $this->container['dayOfWeek'] = $data['dayOfWeek'] ?? null;
     ...
     * Sets dayOfWeek
     *
     * @param string|null $dayOfWeek Specific day of the week for which operating hours are being defined.
     *
     * @return self
     */
     ...
     * Sets timeWindows
     *
     * @param \Webcom\Amazon\Rest\OrdersApi20260101\Model\TimeWindow20260101[]|null $timeWindows Collection of time windows during which the location is available for deliveries on the specified day.
     *
     * @return self
     */
