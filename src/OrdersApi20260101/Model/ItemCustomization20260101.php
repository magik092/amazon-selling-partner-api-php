...
/**
 * ItemCustomization20260101 Class Doc Comment
 *
 * @category Class
 ...
 */
class ItemCustomization20260101 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ItemCustomization';
     ...
     * Sets customizedUrl
     *
     * @param string|null $customizedUrl The URL of the customized data for custom orders from the Amazon Custom program.
     *
     * @return self
     */
