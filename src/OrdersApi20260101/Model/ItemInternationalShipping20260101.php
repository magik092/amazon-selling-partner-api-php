<?php
/**
 * ItemInternationalShipping20260101
 *
 * PHP version 7.2
 *
 * @category Class
...
/**
 * ItemInternationalShipping20260101 Class Doc Comment
 *
 * @category Class
 ...
 */
class ItemInternationalShipping20260101 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ItemInternationalShipping';
     ...
     * Sets iossNumber
     *
     * @param string|null $iossNumber Import One-Stop Shop registration number required for EU VAT compliance when shipping from outside the European Union. Sellers shipping to the EU from outside the EU must provide this IOSS number to their carrier when Amazon has collected the VAT on the sale.
     *
     * @return self
     */
