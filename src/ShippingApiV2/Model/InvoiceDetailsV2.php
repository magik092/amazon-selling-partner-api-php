...
/**
 * InvoiceDetailsV2 Class Doc Comment
 *
 * @category Class
 ...
 */
class InvoiceDetailsV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets invoiceNumber
     *
     * @param string|null $invoiceNumber The invoice number of the item.
     *
     * @return self
     */
     ...
     * Sets invoiceDate
     *
     * @param \DateTime|null $invoiceDate The invoice date of the item in ISO 8061 format.
     *
     * @return self
     */
