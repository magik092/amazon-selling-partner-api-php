...
/**
 * ValueAddedServiceV2 Class Doc Comment
 *
 * @category Class
 ...
 */
class ValueAddedServiceV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'id' => 'string',
        'name' => 'string',
        'cost' => '\Webcom\Amazon\Rest\ShippingApiV2\Model\CurrencyV2'
    ];
     ...
     * Sets cost
     *
     * @param \Webcom\Amazon\Rest\ShippingApiV2\Model\CurrencyV2 $cost cost
     *
     * @return self
     */
