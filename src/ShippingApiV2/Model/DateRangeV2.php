 ...
 */
class DateRangeV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets startDate
     *
     * @param string|null $startDate Start Date for query .
     *
     * @return self
     */
     ...
     * Sets endDate
     *
     * @param string|null $endDate end date for query.
     *
     * @return self
     */
