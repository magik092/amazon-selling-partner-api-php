 ...
 */
class LocationV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets stateOrRegion
     *
     * @param string|null $stateOrRegion The state, county or region where the person, business or institution is located.
     *
     * @return self
     */
     ...
     * Sets countryCode
     *
     * @param string|null $countryCode The two digit country code. Follows ISO 3166-1 alpha-2 format.
     *
     * @return self
     */
