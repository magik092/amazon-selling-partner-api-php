<?php
/**
 * DirectFulfillmentItemIdentifiersV2
 *
 * PHP version 7.2
 *
 * @category Class
...
/**
 * DirectFulfillmentItemIdentifiersV2 Class Doc Comment
 *
 * @category Class
 ...
 */
class DirectFulfillmentItemIdentifiersV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets pieceNumber
     *
     * @param string|null $pieceNumber A unique identifier for an item provided by the client for a direct fulfillment shipment. This is only populated if a single line item has multiple pieces. Defaults to 1.
     *
     * @return self
     */
