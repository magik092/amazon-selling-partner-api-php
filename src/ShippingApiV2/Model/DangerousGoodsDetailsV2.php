...
/**
 * DangerousGoodsDetailsV2 Class Doc Comment
 *
 * @category Class
 ...
 */
class DangerousGoodsDetailsV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setTransportationRegulatoryClass($transportationRegulatoryClass)
    {
        ...
        if (!is_null($transportationRegulatoryClass) && (!preg_match("/^[1-9](\\.[1-9])?$/", $transportationRegulatoryClass))) {
            throw new \InvalidArgumentException("invalid value for $transportationRegulatoryClass when calling DangerousGoodsDetailsV2., must conform to the pattern /^[1-9](\\.[1-9])?$/.");
        }
