 ...
 */
class TimeOfDayV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['hourOfDay'] = $data['hourOfDay'] ?? null;
        $this->container['minuteOfHour'] = $data['minuteOfHour'] ?? null;
        $this->container['secondOfMinute'] = $data['secondOfMinute'] ?? null;
    }
