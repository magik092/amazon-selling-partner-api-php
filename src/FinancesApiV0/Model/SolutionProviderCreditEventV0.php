...
/**
 * SolutionProviderCreditEventV0 Class Doc Comment
 *
 * @category Class
 ...
 */
class SolutionProviderCreditEventV0 implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param \DateTime|null $transactionCreationDate A date in [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) date-time format.
     *
     * @return self
     */
