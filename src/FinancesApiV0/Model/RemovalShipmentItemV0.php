...
/**
 * RemovalShipmentItemV0 Class Doc Comment
 *
 * @category Class
 ...
 */
class RemovalShipmentItemV0 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'quantity' => 'int',
        'revenue' => '\Webcom\Amazon\Rest\FinancesApiV0\Model\CurrencyV0',
        'feeAmount' => '\Webcom\Amazon\Rest\FinancesApiV0\Model\CurrencyV0',
        'taxAmount' => '\Webcom\Amazon\Rest\FinancesApiV0\Model\CurrencyV0',
        'taxWithheld' => '\Webcom\Amazon\Rest\FinancesApiV0\Model\CurrencyV0'
    ];
     ...
     *
     * @param string|null $taxCollectionModel The tax collection model that is applied to the item.  Possible values:  * `MarketplaceFacilitator`: Tax is withheld and remitted to the taxing authority by Amazon on behalf of the seller. * `Standard`: Tax is paid to the seller and not remitted to the taxing authority by Amazon.
     *
     * @return self
     */
     ...
     * Sets revenue
     *
     * @param \Webcom\Amazon\Rest\FinancesApiV0\Model\CurrencyV0|null $revenue revenue
     *
     * @return self
     */
     ...
     * Sets taxWithheld
     *
     * @param \Webcom\Amazon\Rest\FinancesApiV0\Model\CurrencyV0|null $taxWithheld taxWithheld
     *
     * @return self
     */
