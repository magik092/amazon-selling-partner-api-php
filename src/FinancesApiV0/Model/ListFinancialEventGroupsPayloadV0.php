<?php
/**
 * ListFinancialEventGroupsPayloadV0
 *
 * PHP version 7.2
 *
 * @category Class
...
/**
 * ListFinancialEventGroupsPayloadV0 Class Doc Comment
 *
 * @category Class
 ...
 */
class ListFinancialEventGroupsPayloadV0 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'nextToken' => 'string',
        'financialEventGroupList' => '\Webcom\Amazon\Rest\FinancesApiV0\Model\FinancialEventGroupV0[]'
    ];
     ...
     *
     * @return \Webcom\Amazon\Rest\FinancesApiV0\Model\FinancialEventGroupV0[]|null
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\FinancesApiV0\Model\FinancialEventGroupV0[]|null $financialEventGroupList A list of financial event group information.
     *
     * @return self
     */
