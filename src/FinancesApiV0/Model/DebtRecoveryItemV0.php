...
class DebtRecoveryItemV0 implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets groupBeginDate
     *
     * @param \DateTime|null $groupBeginDate A date in [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) date-time format.
     *
     * @return self
     */
     ...
     * Sets groupEndDate
     *
     * @param \DateTime|null $groupEndDate A date in [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) date-time format.
     *
     * @return self
     */
