<?php
/**
 * EBTRefundReimbursementOnlyEventV0
 *
 * PHP version 7.2
 *
 * @category Class
...
/**
 * EBTRefundReimbursementOnlyEventV0 Class Doc Comment
 *
 * @category Class
 ...
 */
class EBTRefundReimbursementOnlyEventV0 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EBTRefundReimbursementOnlyEvent';
    ...
    protected static $openAPITypes = [
        'orderId' => 'string',
        'postedDate' => '\DateTime',
        'amount' => '\Webcom\Amazon\Rest\FinancesApiV0\Model\CurrencyV0'
    ];
     ...
     * Sets orderId
     *
     * @param string|null $orderId The identifier of an order.
     *
     * @return self
     */
     ...
     * Sets amount
     *
     * @param \Webcom\Amazon\Rest\FinancesApiV0\Model\CurrencyV0|null $amount amount
     *
     * @return self
     */
