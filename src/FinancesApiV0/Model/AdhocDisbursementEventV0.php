...
/**
 * AdhocDisbursementEventV0 Class Doc Comment
 *
 * @category Class
 ...
 */
class AdhocDisbursementEventV0 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'transactionAmount' => '\Webcom\Amazon\Rest\FinancesApiV0\Model\CurrencyV0',
    ];
    /**
     ...
     *
     * @param string|null $transactionType The type of transaction. For example, \"Disbursed to Amazon Gift Card balance\".
     *
     * @return self
     */
     ...
     * Sets transactionId
     *
     * @param string|null $transactionId The identifier for the transaction.
     *
     * @return self
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\FinancesApiV0\Model\CurrencyV0|null $transactionAmount transactionAmount
     *
     * @return self
     */
