...
/**
 * Pagination20220401 Class Doc Comment
 *
 * @category Class
 ...
 */
class Pagination20220401 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['previousToken'] = $data['previousToken'] ?? null;
    }
     ...
     * Sets nextToken
     *
     * @param string|null $nextToken A token that you can use to retrieve the next page.
     *
     * @return self
     */
     ...
     * Sets previousToken
     *
     * @param string|null $previousToken A token that you can use to retrieve the previous page.
     *
     * @return self
     */
