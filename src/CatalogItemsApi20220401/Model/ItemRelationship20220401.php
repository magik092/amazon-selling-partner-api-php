...
class ItemRelationship20220401 implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets childAsins
     *
     * @param string[]|null $childAsins ASINs of the related items that are children of this item.
     *
     * @return self
     */
     ...
     * Sets parentAsins
     *
     * @param string[]|null $parentAsins ASINs of the related items that are parents of this item.
     *
     * @return self
     */
