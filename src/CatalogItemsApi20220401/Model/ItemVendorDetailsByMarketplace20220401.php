...
class ItemVendorDetailsByMarketplace20220401 implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets brandCode
     *
     * @param string|null $brandCode The brand code that is associated with an Amazon catalog item.
     *
     * @return self
     */
     ...
     *
     * @param string|null $manufacturerCode The manufacturer code that is associated with an Amazon catalog item.
     *
     * @return self
     */
     ...
     *
     * @param string|null $manufacturerCodeParent The parent vendor code of the manufacturer code.
     *
     * @return self
     */
     ...
     * Sets productGroup
     *
     * @param string|null $productGroup The product group that is associated with an Amazon catalog item.
     *
     * @return self
     */
     ...
     *
     * @param string|null $replenishmentCategory The replenishment category that is associated with an Amazon catalog item.
     *
     * @return self
     */
