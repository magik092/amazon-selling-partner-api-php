...
class TestNotification implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TestNotification';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['testScenario'] = $data['testScenario'] ?? null;
    }
    ...
    {
        return $this->container['testScenario'];
    }

    /**
     * Sets testScenario
     *
     * @param string|null $testScenario The scenario of the specified notification to be used in the notification payload. If testScenario is empty, a 400 response will be returned back to the developer. The scenarios supported for each notification type can be found in the Selling Partner API Developer Guide.
     *
     * @return self
     */
    public function setTestScenario($testScenario)
    {
        $this->container['testScenario'] = $testScenario;
