 ...
 */
class Pagination20211028 implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets nextToken
     *
     * @param string|null $nextToken A generated token to be passed in the next request to retrieve the next set of results.
     *
     * @return self
     */
