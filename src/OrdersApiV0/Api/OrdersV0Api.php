...
class OrdersV0Api
{
     ...
     * @param  \Webcom\Amazon\Rest\OrdersApiV0\Model\ConfirmShipmentRequestV0 $payload Request body of &#x60;confirmShipment&#x60;. (required)
     *
     * @throws \Webcom\Amazon\Rest\OrdersApiV0\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function confirmShipment($orderId, $payload)
    {
        $this->confirmShipmentWithHttpInfo($orderId, $payload);
    }
     ...
     */
    public function confirmShipmentWithHttpInfo($orderId, $payload)
    {
        $request = $this->confirmShipmentRequest($orderId, $payload);
            ...
            switch ($e->getCode()) {
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Webcom\Amazon\Rest\OrdersApiV0\Model\ConfirmShipmentErrorResponseV0',
     ...
     */
    public function confirmShipmentAsync($orderId, $payload)
    {
        return $this->confirmShipmentAsyncWithHttpInfo($orderId, $payload)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function confirmShipmentAsyncWithHttpInfo($orderId, $payload)
    {
        $returnType = '';
        $request = $this->confirmShipmentRequest($orderId, $payload);
     ...
     */
    public function confirmShipmentRequest($orderId, $payload)
    {
     ...
     * @throws \Webcom\Amazon\Rest\OrdersApiV0\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderResponseV0|\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderResponseV0|\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderResponseV0|\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderResponseV0|\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderResponseV0|\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderResponseV0|\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderResponseV0, HTTP status code, HTTP response headers (array of strings)
     */
    public function getOrderWithHttpInfo($orderId)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderResponseV0' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderResponseV0', []),
            ...
            $returnType = '\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderResponseV0';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderResponseV0',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Webcom\Amazon\Rest\OrdersApiV0\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderAddressResponseV0|\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderAddressResponseV0|\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderAddressResponseV0|\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderAddressResponseV0|\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderAddressResponseV0|\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderAddressResponseV0|\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderAddressResponseV0
     */
     ...
     * @throws \Webcom\Amazon\Rest\OrdersApiV0\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderAddressResponseV0|\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderAddressResponseV0|\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderAddressResponseV0|\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderAddressResponseV0|\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderAddressResponseV0|\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderAddressResponseV0|\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderAddressResponseV0, HTTP status code, HTTP response headers (array of strings)
     */
    public function getOrderAddressWithHttpInfo($orderId)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderAddressResponseV0' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderAddressResponseV0', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderAddressResponseV0';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderAddressResponseV0',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Webcom\Amazon\Rest\OrdersApiV0\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderBuyerInfoResponseV0|\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderBuyerInfoResponseV0|\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderBuyerInfoResponseV0|\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderBuyerInfoResponseV0|\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderBuyerInfoResponseV0|\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderBuyerInfoResponseV0|\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderBuyerInfoResponseV0
     */
     ...
     * @throws \Webcom\Amazon\Rest\OrdersApiV0\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderBuyerInfoResponseV0|\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderBuyerInfoResponseV0|\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderBuyerInfoResponseV0|\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderBuyerInfoResponseV0|\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderBuyerInfoResponseV0|\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderBuyerInfoResponseV0|\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderBuyerInfoResponseV0, HTTP status code, HTTP response headers (array of strings)
     */
    public function getOrderBuyerInfoWithHttpInfo($orderId)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderBuyerInfoResponseV0' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderBuyerInfoResponseV0', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderBuyerInfoResponseV0';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderBuyerInfoResponseV0',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Webcom\Amazon\Rest\OrdersApiV0\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderItemsResponseV0|\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderItemsResponseV0|\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderItemsResponseV0|\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderItemsResponseV0|\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderItemsResponseV0|\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderItemsResponseV0|\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderItemsResponseV0
     */
     ...
     * @throws \Webcom\Amazon\Rest\OrdersApiV0\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderItemsResponseV0|\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderItemsResponseV0|\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderItemsResponseV0|\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderItemsResponseV0|\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderItemsResponseV0|\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderItemsResponseV0|\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderItemsResponseV0, HTTP status code, HTTP response headers (array of strings)
     */
    public function getOrderItemsWithHttpInfo($orderId, $nextToken = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderItemsResponseV0' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderItemsResponseV0', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderItemsResponseV0';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderItemsResponseV0',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Webcom\Amazon\Rest\OrdersApiV0\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderItemsBuyerInfoResponseV0|\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderItemsBuyerInfoResponseV0|\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderItemsBuyerInfoResponseV0|\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderItemsBuyerInfoResponseV0|\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderItemsBuyerInfoResponseV0|\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderItemsBuyerInfoResponseV0|\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderItemsBuyerInfoResponseV0
     */
     ...
     * @throws \Webcom\Amazon\Rest\OrdersApiV0\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderItemsBuyerInfoResponseV0|\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderItemsBuyerInfoResponseV0|\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderItemsBuyerInfoResponseV0|\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderItemsBuyerInfoResponseV0|\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderItemsBuyerInfoResponseV0|\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderItemsBuyerInfoResponseV0|\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderItemsBuyerInfoResponseV0, HTTP status code, HTTP response headers (array of strings)
     */
    public function getOrderItemsBuyerInfoWithHttpInfo($orderId, $nextToken = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderItemsBuyerInfoResponseV0' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderItemsBuyerInfoResponseV0', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderItemsBuyerInfoResponseV0';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderItemsBuyerInfoResponseV0',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Webcom\Amazon\Rest\OrdersApiV0\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderRegulatedInfoResponseV0|\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderRegulatedInfoResponseV0|\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderRegulatedInfoResponseV0|\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderRegulatedInfoResponseV0|\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderRegulatedInfoResponseV0|\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderRegulatedInfoResponseV0|\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderRegulatedInfoResponseV0
     */
     ...
     * @throws \Webcom\Amazon\Rest\OrdersApiV0\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderRegulatedInfoResponseV0|\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderRegulatedInfoResponseV0|\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderRegulatedInfoResponseV0|\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderRegulatedInfoResponseV0|\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderRegulatedInfoResponseV0|\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderRegulatedInfoResponseV0|\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderRegulatedInfoResponseV0, HTTP status code, HTTP response headers (array of strings)
     */
    public function getOrderRegulatedInfoWithHttpInfo($orderId)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderRegulatedInfoResponseV0' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderRegulatedInfoResponseV0', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderRegulatedInfoResponseV0';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrderRegulatedInfoResponseV0',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getOrderRegulatedInfoRequest($orderId)
    {
        // verify the required parameter 'orderId' is set
        if ($orderId === null || (is_array($orderId) && count($orderId) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @param  string $earliestDeliveryDateBefore Use this date to select orders with a earliest delivery date before (or at) a specified time. The date must be in [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) format. (optional)
     * @param  string $earliestDeliveryDateAfter Use this date to select orders with a earliest delivery date after (or at) a specified time. The date must be in [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) format. (optional)
     ...
     * @throws \Webcom\Amazon\Rest\OrdersApiV0\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrdersResponseV0|\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrdersResponseV0|\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrdersResponseV0|\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrdersResponseV0|\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrdersResponseV0|\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrdersResponseV0|\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrdersResponseV0, HTTP status code, HTTP response headers (array of strings)
     */
    public function getOrdersWithHttpInfo($marketplaceIds, $createdAfter = null, $createdBefore = null, $lastUpdatedAfter = null, $lastUpdatedBefore = null, $orderStatuses = null, $fulfillmentChannels = null, $paymentMethods = null, $buyerEmail = null, $sellerOrderId = null, $maxResultsPerPage = null, $easyShipShipmentStatuses = null, $electronicInvoiceStatuses = null, $nextToken = null, $amazonOrderIds = null, $actualFulfillmentSupplySourceId = null, $isISPU = null, $storeChainStoreId = null, $earliestDeliveryDateBefore = null, $earliestDeliveryDateAfter = null, $latestDeliveryDateBefore = null, $latestDeliveryDateAfter = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrdersResponseV0' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrdersResponseV0', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrdersResponseV0';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Webcom\Amazon\Rest\OrdersApiV0\Model\GetOrdersResponseV0',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getOrdersRequest($marketplaceIds, $createdAfter = null, $createdBefore = null, $lastUpdatedAfter = null, $lastUpdatedBefore = null, $orderStatuses = null, $fulfillmentChannels = null, $paymentMethods = null, $buyerEmail = null, $sellerOrderId = null, $maxResultsPerPage = null, $easyShipShipmentStatuses = null, $electronicInvoiceStatuses = null, $nextToken = null, $amazonOrderIds = null, $actualFulfillmentSupplySourceId = null, $isISPU = null, $storeChainStoreId = null, $earliestDeliveryDateBefore = null, $earliestDeliveryDateAfter = null, $latestDeliveryDateBefore = null, $latestDeliveryDateAfter = null)
    {
        ...
        if (is_array($electronicInvoiceStatuses)) {
            $electronicInvoiceStatuses = ObjectSerializer::serializeCollection($electronicInvoiceStatuses, 'form', true);
        }
        if ($electronicInvoiceStatuses !== null) {
            $queryParams['ElectronicInvoiceStatuses'] = $electronicInvoiceStatuses;
        }
        // query params
        if (is_array($nextToken)) {
            $nextToken = ObjectSerializer::serializeCollection($nextToken, '', true);
        ...
        // query params
        if (is_array($earliestDeliveryDateBefore)) {
            $earliestDeliveryDateBefore = ObjectSerializer::serializeCollection($earliestDeliveryDateBefore, '', true);
        }
        if ($earliestDeliveryDateBefore !== null) {
            $queryParams['EarliestDeliveryDateBefore'] = $earliestDeliveryDateBefore;
        }
        // query params
        if (is_array($earliestDeliveryDateAfter)) {
            $earliestDeliveryDateAfter = ObjectSerializer::serializeCollection($earliestDeliveryDateAfter, '', true);
        }
        if ($earliestDeliveryDateAfter !== null) {
            $queryParams['EarliestDeliveryDateAfter'] = $earliestDeliveryDateAfter;
        }
        // query params
        if (is_array($latestDeliveryDateBefore)) {
            $latestDeliveryDateBefore = ObjectSerializer::serializeCollection($latestDeliveryDateBefore, '', true);
        }
        if ($latestDeliveryDateBefore !== null) {
            $queryParams['LatestDeliveryDateBefore'] = $latestDeliveryDateBefore;
        }
        // query params
        if (is_array($latestDeliveryDateAfter)) {
            $latestDeliveryDateAfter = ObjectSerializer::serializeCollection($latestDeliveryDateAfter, '', true);
        }
        if ($latestDeliveryDateAfter !== null) {
            $queryParams['LatestDeliveryDateAfter'] = $latestDeliveryDateAfter;
        }
     ...
     *
     * @param  string $orderId An Amazon-defined order identifier, in 3-7-7 format. (required)
     * @param  \Webcom\Amazon\Rest\OrdersApiV0\Model\UpdateVerificationStatusRequestV0 $payload The request body for the &#x60;updateVerificationStatus&#x60; operation. (required)
     *
     * @throws \Webcom\Amazon\Rest\OrdersApiV0\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function updateVerificationStatus($orderId, $payload)
    {
        $this->updateVerificationStatusWithHttpInfo($orderId, $payload);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateVerificationStatusWithHttpInfo($orderId, $payload)
    {
        $request = $this->updateVerificationStatusRequest($orderId, $payload);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Webcom\Amazon\Rest\OrdersApiV0\Model\UpdateVerificationStatusErrorResponseV0',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateVerificationStatusAsync($orderId, $payload)
    {
        return $this->updateVerificationStatusAsyncWithHttpInfo($orderId, $payload)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateVerificationStatusAsyncWithHttpInfo($orderId, $payload)
    {
        $returnType = '';
        $request = $this->updateVerificationStatusRequest($orderId, $payload);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateVerificationStatusRequest($orderId, $payload)
    {
        // verify the required parameter 'orderId' is set
        if ($orderId === null || (is_array($orderId) && count($orderId) === 0)) {
            throw new \InvalidArgumentException(
