...
/**
 * BuyerTaxInformationV0 Class Doc Comment
 *
 * @category Class
 ...
 */
class BuyerTaxInformationV0 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['buyerLegalCompanyName'] = $data['buyerLegalCompanyName'] ?? null;
        $this->container['buyerBusinessAddress'] = $data['buyerBusinessAddress'] ?? null;
        $this->container['buyerTaxRegistrationId'] = $data['buyerTaxRegistrationId'] ?? null;
        $this->container['buyerTaxOffice'] = $data['buyerTaxOffice'] ?? null;
    }
