...
/**
 * FulfillmentInstructionV0 Class Doc Comment
 *
 * @category Class
 ...
 */
class FulfillmentInstructionV0 implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param string|null $fulfillmentSupplySourceId The `sourceId` of the location from where you want the order fulfilled.
     *
     * @return self
     */
