...
/**
 * ProductInfoDetailV0 Class Doc Comment
 *
 * @category Class
 ...
 */
class ProductInfoDetailV0 implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets numberOfItems
     *
     * @param string|null $numberOfItems The total number of items that are included in the ASIN.
     *
     * @return self
     */
