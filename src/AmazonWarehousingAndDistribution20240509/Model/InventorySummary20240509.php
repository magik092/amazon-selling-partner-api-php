...
class InventorySummary20240509 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'expirationDetails' => '\Webcom\Amazon\Rest\AmazonWarehousingAndDistribution20240509\Model\ExpirationDetails20240509[]',
    ...
    {
        $this->container['expirationDetails'] = $data['expirationDetails'] ?? null;
     ...
     *
     * @return \Webcom\Amazon\Rest\AmazonWarehousingAndDistribution20240509\Model\ExpirationDetails20240509[]|null
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\AmazonWarehousingAndDistribution20240509\Model\ExpirationDetails20240509[]|null $expirationDetails The expiration details of the inventory. This object will only appear if the `details` parameter in the request is set to `SHOW`.
     *
     * @return self
     */
