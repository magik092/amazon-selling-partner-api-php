...
/**
 * ExcludedBenefitV0 Class Doc Comment
 *
 * @category Class
 ...
 */
class ExcludedBenefitV0 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExcludedBenefit';
     ...
     * Sets reasonCodes
     *
     * @param string[]|null $reasonCodes List of reasons why a benefit is excluded for a shipping offer (for example, `LATE_DELIVERY_RISK`).
     *
     * @return self
     */
