 ...
 */
class LabelV0 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'dimensions' => '\Webcom\Amazon\Rest\MerchantFulfillmentApiV0\Model\LabelDimensionsV0',
        'fileContents' => '\Webcom\Amazon\Rest\MerchantFulfillmentApiV0\Model\FileContentsV0',
        'labelFormat' => '\Webcom\Amazon\Rest\MerchantFulfillmentApiV0\Model\LabelFormatV0',
        'standardIdForLabel' => '\Webcom\Amazon\Rest\MerchantFulfillmentApiV0\Model\StandardIdForLabelV0'
    ];
    ...
    public function setCustomTextForLabel($customTextForLabel)
    {
        if (!is_null($customTextForLabel) && (mb_strlen($customTextForLabel) > 14)) {
            throw new \InvalidArgumentException('invalid length for $customTextForLabel when calling LabelV0., must be smaller than or equal to 14.');
        }
     ...
     * Gets dimensions
     *
     * @return \Webcom\Amazon\Rest\MerchantFulfillmentApiV0\Model\LabelDimensionsV0
     */
     ...
     * Sets dimensions
     *
     * @param \Webcom\Amazon\Rest\MerchantFulfillmentApiV0\Model\LabelDimensionsV0 $dimensions dimensions
     *
     * @return self
     */
     ...
     * Gets fileContents
     *
     * @return \Webcom\Amazon\Rest\MerchantFulfillmentApiV0\Model\FileContentsV0
     */
     ...
     * Sets fileContents
     *
     * @param \Webcom\Amazon\Rest\MerchantFulfillmentApiV0\Model\FileContentsV0 $fileContents fileContents
     *
     * @return self
     */
     ...
     * Gets labelFormat
     *
     * @return \Webcom\Amazon\Rest\MerchantFulfillmentApiV0\Model\LabelFormatV0|null
     */
     ...
     * Sets labelFormat
     *
     * @param \Webcom\Amazon\Rest\MerchantFulfillmentApiV0\Model\LabelFormatV0|null $labelFormat labelFormat
     *
     * @return self
     */
     ...
     *
     * @return \Webcom\Amazon\Rest\MerchantFulfillmentApiV0\Model\StandardIdForLabelV0|null
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\MerchantFulfillmentApiV0\Model\StandardIdForLabelV0|null $standardIdForLabel standardIdForLabel
     *
     * @return self
     */
