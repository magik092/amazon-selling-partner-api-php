...
/**
 * CurrencyAmountV0 Class Doc Comment
 *
 * @category Class
 ...
 */
class CurrencyAmountV0 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setCurrencyCode($currencyCode)
    {
        if ((mb_strlen($currencyCode) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currencyCode when calling CurrencyAmountV0., must be smaller than or equal to 3.');
        }
