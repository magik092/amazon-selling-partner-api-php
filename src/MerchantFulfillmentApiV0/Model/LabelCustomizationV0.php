...
/**
 * LabelCustomizationV0 Class Doc Comment
 *
 * @category Class
 ...
 */
class LabelCustomizationV0 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setCustomTextForLabel($customTextForLabel)
    {
        if (!is_null($customTextForLabel) && (mb_strlen($customTextForLabel) > 14)) {
            throw new \InvalidArgumentException('invalid length for $customTextForLabel when calling LabelCustomizationV0., must be smaller than or equal to 14.');
        }
