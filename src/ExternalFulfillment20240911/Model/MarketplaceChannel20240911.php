...
/**
 * MarketplaceChannel20240911 Class Doc Comment
 *
 * @category Class
 ...
 */
class MarketplaceChannel20240911 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MarketplaceChannel';
     ...
     * Sets channelName
     *
     * @param string|null $channelName The name of the channel within the marketplace.
     *
     * @return self
     */
