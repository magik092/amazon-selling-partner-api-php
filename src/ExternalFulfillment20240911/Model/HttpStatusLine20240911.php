...
/**
 * HttpStatusLine20240911 Class Doc Comment
 *
 * @category Class
 ...
 */
class HttpStatusLine20240911 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setStatusCode($statusCode)
    {
        ...
        if (!is_null($statusCode) && ($statusCode > 599)) {
            throw new \InvalidArgumentException('invalid value for $statusCode when calling HttpStatusLine20240911., must be smaller than or equal to 599.');
        }
        if (!is_null($statusCode) && ($statusCode < 100)) {
            throw new \InvalidArgumentException('invalid value for $statusCode when calling HttpStatusLine20240911., must be bigger than or equal to 100.');
        }
