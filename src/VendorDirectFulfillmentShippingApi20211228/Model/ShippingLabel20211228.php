...
/**
 * ShippingLabel20211228 Class Doc Comment
 *
 * @category Class
 ...
 */
class ShippingLabel20211228 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'labelFormat' => 'string',
        'labelData' => '\Webcom\Amazon\Rest\VendorDirectFulfillmentShippingApi20211228\Model\LabelData20211228[]'
    ];
    ...
    public function setPurchaseOrderNumber($purchaseOrderNumber)
    {
        ...
        if ((!preg_match("/^[a-zA-Z0-9]+$/", $purchaseOrderNumber))) {
            throw new \InvalidArgumentException("invalid value for $purchaseOrderNumber when calling ShippingLabel20211228., must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
     ...
     * Gets labelData
     *
     * @return \Webcom\Amazon\Rest\VendorDirectFulfillmentShippingApi20211228\Model\LabelData20211228[]
     */
     ...
     * Sets labelData
     *
     * @param \Webcom\Amazon\Rest\VendorDirectFulfillmentShippingApi20211228\Model\LabelData20211228[] $labelData Provides the details of the packages in this shipment.
     *
     * @return self
     */
