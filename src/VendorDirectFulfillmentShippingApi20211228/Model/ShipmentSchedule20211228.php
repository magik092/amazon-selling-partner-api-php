...
/**
 * ShipmentSchedule20211228 Class Doc Comment
 *
 * @category Class
 ...
 */
class ShipmentSchedule20211228 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['estimatedDeliveryDateTime'] = $data['estimatedDeliveryDateTime'] ?? null;
        $this->container['apptWindowStartDateTime'] = $data['apptWindowStartDateTime'] ?? null;
        $this->container['apptWindowEndDateTime'] = $data['apptWindowEndDateTime'] ?? null;
    }
     ...
     *
     * @param \DateTime|null $estimatedDeliveryDateTime Date on which the shipment is expected to reach the customer delivery location. Values are in [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) date-time format, with UTC time zone or UTC offset. For example, 2020-07-16T23:00:00Z or 2020-07-16T23:00:00+01:00.
     *
     * @return self
     */
