 ...
 */
class ShippingLabelRequest20211228 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setPurchaseOrderNumber($purchaseOrderNumber)
    {
        ...
        if ((!preg_match("/^[a-zA-Z0-9]+$/", $purchaseOrderNumber))) {
            throw new \InvalidArgumentException("invalid value for $purchaseOrderNumber when calling ShippingLabelRequest20211228., must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
     ...
     * Sets containers
     *
     * @param \Webcom\Amazon\Rest\VendorDirectFulfillmentShippingApi20211228\Model\Container20211228[]|null $containers A list of the packages in this shipment.
     *
     * @return self
     */
