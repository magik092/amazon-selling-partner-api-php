...
/**
 * PackingSlip20211228 Class Doc Comment
 *
 * @category Class
 ...
 */
class PackingSlip20211228 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setPurchaseOrderNumber($purchaseOrderNumber)
    {
        ...
        if ((!preg_match("/^[a-zA-Z0-9]+$/", $purchaseOrderNumber))) {
            throw new \InvalidArgumentException("invalid value for $purchaseOrderNumber when calling PackingSlip20211228., must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
