...
/**
 * ShipmentConfirmation20211228 Class Doc Comment
 *
 * @category Class
 ...
 */
class ShipmentConfirmation20211228 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'shipmentDetails' => '\Webcom\Amazon\Rest\VendorDirectFulfillmentShippingApi20211228\Model\ShipmentDetails20211228',
        ...
        'items' => '\Webcom\Amazon\Rest\VendorDirectFulfillmentShippingApi20211228\Model\Item20211228[]',
        'containers' => '\Webcom\Amazon\Rest\VendorDirectFulfillmentShippingApi20211228\Model\Container20211228[]'
    ];
    ...
    public function setPurchaseOrderNumber($purchaseOrderNumber)
    {
        ...
        if ((!preg_match("/^[a-zA-Z0-9]+$/", $purchaseOrderNumber))) {
            throw new \InvalidArgumentException("invalid value for $purchaseOrderNumber when calling ShipmentConfirmation20211228., must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
     ...
     *
     * @return \Webcom\Amazon\Rest\VendorDirectFulfillmentShippingApi20211228\Model\ShipmentDetails20211228
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\VendorDirectFulfillmentShippingApi20211228\Model\ShipmentDetails20211228 $shipmentDetails shipmentDetails
     *
     * @return self
     */
     ...
     * Gets items
     *
     * @return \Webcom\Amazon\Rest\VendorDirectFulfillmentShippingApi20211228\Model\Item20211228[]
     */
     ...
     * Sets items
     *
     * @param \Webcom\Amazon\Rest\VendorDirectFulfillmentShippingApi20211228\Model\Item20211228[] $items Provide the details of the items in this shipment. If any of the item details field is common at a package or a pallet level, then provide them at the corresponding package.
     *
     * @return self
     */
     ...
     * Gets containers
     *
     * @return \Webcom\Amazon\Rest\VendorDirectFulfillmentShippingApi20211228\Model\Container20211228[]|null
     */
     ...
     * Sets containers
     *
     * @param \Webcom\Amazon\Rest\VendorDirectFulfillmentShippingApi20211228\Model\Container20211228[]|null $containers Provide the details of the items in this shipment. If any of the item details field is common at a package or a pallet level, then provide them at the corresponding package.
     *
     * @return self
     */
