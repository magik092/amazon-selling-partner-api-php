...
class PaymentTerms implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['discountDueDays'] = $data['discountDueDays'] ?? null;
        $this->container['netDueDays'] = $data['netDueDays'] ?? null;
    }
     ...
     *
     * @param string|null $discountPercent A decimal number with no loss of precision. Useful when precision loss is unacceptable, as with currencies. Follows RFC7159 for number representation. <br>**Pattern** : `^-?(0|([1-9]\\d*))(\\.\\d+)?([eE][+-]?\\d+)?$`.
     *
     * @return self
     */
     ...
     * Sets netDueDays
     *
     * @param float|null $netDueDays The number of calendar days from the base date (invoice date) until the total amount on the invoice is due.
     *
     * @return self
     */
